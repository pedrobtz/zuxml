...
- **Thai Open Source Software Center Ltd**. Copyright holder.  
  Expat, bundled in src/vendor/expat

- **Clark Cooper**. Copyright holder.  
  Expat, bundled in src/vendor/expat

- **Expat maintainers**. Copyright holder.  
  Expat, bundled in src/vendor/expat
...
Tree*. R package version 0.0.0.9000,
