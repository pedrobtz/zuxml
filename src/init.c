...
static const R_CallMethodDef call_methods[] = {
    ...
    {"C_zux_stream_begin", (DL_FUNC)&C_zux_stream_begin, 1},
    {"C_zux_stream_feed", (DL_FUNC)&C_zux_stream_feed, 2},
    {"C_zux_stream_end", (DL_FUNC)&C_zux_stream_end, 1},
    {"C_zux_stream_abort", (DL_FUNC)&C_zux_stream_abort, 1},
